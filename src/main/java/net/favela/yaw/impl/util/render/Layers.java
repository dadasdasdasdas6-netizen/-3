...
import static net.favela.yaw.impl.util.render.Pipelines.GLOBAL_LINES_PIPELINE;
import static net.favela.yaw.impl.util.render.Pipelines.GLOBAL_QUADS_PIPELINE;
